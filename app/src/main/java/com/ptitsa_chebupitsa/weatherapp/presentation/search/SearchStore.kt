...
import com.ptitsa_chebupitsa.weatherapp.presentation.search.SearchStore.Intent
import com.ptitsa_chebupitsa.weatherapp.presentation.search.SearchStore.Label
import com.ptitsa_chebupitsa.weatherapp.presentation.search.SearchStore.State
                ...
                Intent.ClickSearch -> {
                    ...
                    searchJob = scope.launch {
                        try {
                            ...
                            val city = searchCityUseCase(getState().searchQuery)
                            dispatch(Msg.SearchResultLoaded(city))
                        } catch (e: Exception) {
